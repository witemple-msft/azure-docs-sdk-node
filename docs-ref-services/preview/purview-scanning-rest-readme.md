...
keywords: Azure, javascript, SDK, API, @azure-rest/purview-scanning, azurepurviewscanning
author: maggiepint
ms.author: magpint
ms.date: 08/03/2021
ms.topic: reference
...
ms.service: azurepurviewscanning
---

# Azure Purview Scanning Rest-Level client library for JavaScript - Version 1.0.0-alpha.20210723.1 
